...
namespace TwiApp.ViewModels.O
{
    ...
    public class LetterOViewModel : INotifyPropertyChanged
    {
        ...
        public LetterOViewModel()
        {
            ...
            {
                new LetterAModel { EnglishName = "African", Image = "african.gif", Mp3Path = "AFRICAN.mp3", TWIName = "Obibini", TwiMp3Path = "OBIBINI.mp3"},
                new LetterAModel { EnglishName = "Alligator", Image = "alligator.jpg", Mp3Path = "ALLIGATOR.mp3", TWIName = "Okyekye", TwiMp3Path = "OKYEKYE.mp3"},
                new LetterAModel { EnglishName = "Board game", Image = "boardgame.png", Mp3Path = "BOARDGAME.mp3", TWIName = "Oware", TwiMp3Path = "OWARE.mp3"},
                new LetterAModel { EnglishName = "Boat", Image = "boat.jpg", Mp3Path = "BOAT.mp3", TWIName = "Obonto", TwiMp3Path = "OBONTO.mp3"},
                new LetterAModel { EnglishName = "Caterpillar", Image = "caterpillar.jpg", Mp3Path = "CATERPILLAR.mp3", TWIName = "Osa", TwiMp3Path = "OSA.mp3"},
                ...
                new LetterAModel { EnglishName = "Sheep", Image = "sheep.jpg", Mp3Path = "SHEEP.mp3", TWIName = "Odwan", TwiMp3Path = "ODWAN.mp3"},
                new LetterAModel { EnglishName = "Squirrel", Image = "squirrel.jpg", Mp3Path = "SQUIRREL.mp3", TWIName = "Opuro", TwiMp3Path = "OPURO.mp3"},
                new LetterAModel { EnglishName = "Sun", Image = "sun.jpg", Mp3Path = "SUN.mp3", TWIName = "Owia", TwiMp3Path = "OWIA.mp3"},
            };
            currentIndex = 0;
