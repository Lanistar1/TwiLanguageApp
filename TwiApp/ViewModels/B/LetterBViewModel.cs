    ...
    public class LetterBViewModel : INotifyPropertyChanged
    {
        ...
        public LetterBViewModel()
        {
            ...
            ContentList = new List<LetterAModel>
            {
                ...
                new LetterAModel { EnglishName = "Ball", Image = "ball.png", Mp3Path = "FOOTBALL.mp3", TWIName = "Bɔɔlo", TwiMp3Path = "B))LO.mp3"},
                ...
                new LetterAModel { EnglishName = "Kolanut", Image = "kolanut.png", Mp3Path = "KOLANUT.mp3", TWIName = "Bese", TwiMp3Path = "BESE.mp3"},
                ...
                new LetterAModel { EnglishName = "Ribbons", Image = "ribbon.jpg", Mp3Path = "RIBBON.mp3", TWIName = "Bamma", TwiMp3Path = "BAMMA.mp3"},
