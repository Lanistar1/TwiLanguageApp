    ...
    public class LetterMViewModel : INotifyPropertyChanged
    {
        ...
        public LetterMViewModel()
        {
            ...
            ContentList = new List<LetterAModel>
            {
                ...
                new LetterAModel { EnglishName = "Horns", Image = "horn.png", Mp3Path = "HORN.mp3", TWIName = "Mmɛn", TwiMp3Path = "AB3N.mp3"},
                ...
                new LetterAModel { EnglishName = "Window", Image = "window.jpg", Mp3Path = "WINDOW.mp3", TWIName = "Mpoma", TwiMp3Path = "MPOMA.mp3"},
