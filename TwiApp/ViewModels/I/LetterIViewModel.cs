    ...
    public class LetterIViewModel : INotifyPropertyChanged
    {
        ...
        public LetterIViewModel()
        {
            ...
            ContentList = new List<LetterAModel>
            {
                ...
                new LetterAModel { EnglishName = "greet", Image = "greet.png", Mp3Path = "GREET.mp3", TWIName = "Kyea", TwiMp3Path = "KYEA.mp3"},
                new LetterAModel { EnglishName = "Jump", Image = "jump.png", Mp3Path = "JUMP.mp3", TWIName = "Huri", TwiMp3Path = "HURI.mp3"},
                new LetterAModel { EnglishName = "Meeting", Image = "meeting.png", Mp3Path = "MEETING.mp3", TWIName = "Nhyiamu", TwiMp3Path = "NHYIAMU.mp3"},
                new LetterAModel { EnglishName = "Occiput", Image = "occiput.png", Mp3Path = "OCCIPUT.mp3", TWIName = "Atikɔ", TwiMp3Path = "ATIK).mp3"},
