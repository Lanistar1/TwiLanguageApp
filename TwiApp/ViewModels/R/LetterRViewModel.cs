...
namespace TwiApp.ViewModels.R
{
    ...
    public class LetterRViewModel : INotifyPropertyChanged
    {
        ...
        public LetterRViewModel()
        {
            ...
            {
                new LetterAModel { EnglishName = "Boss", Image = "boss.jpg", Mp3Path = "boss.mp3", TWIName = "Adwumawura", TwiMp3Path = "adwumawura.mp3"},
                ...
                new LetterAModel { EnglishName = "Come", Image = "come.jpg", Mp3Path = "COME.mp3", TWIName = "Bra", TwiMp3Path = "BRA.mp3"},
                new LetterAModel { EnglishName = "Playground", Image = "field.jpg", Mp3Path = "PLAYGROUND.mp3", TWIName = "Agoprama so", TwiMp3Path = "Agopramaso.mp3"},
                new LetterAModel { EnglishName = "Hawk", Image = "halk.jpg", Mp3Path = "HAWK.mp3", TWIName = "Akoroma", TwiMp3Path = "AKOROMA.mp3"},
                new LetterAModel { EnglishName = "Laughter", Image = "laugh.jpg", Mp3Path = "laughter.mp3", TWIName = "Sereɛ", TwiMp3Path = "sere3.mp3"},
                ...
                new LetterAModel { EnglishName = "Turkey", Image = "turkey.jpg", Mp3Path = "turkey.mp3", TWIName = "Kurokurokoko", TwiMp3Path = "krokrokoko.mp3"},
