    ...
    public class LetterEViewModel : INotifyPropertyChanged
    {
        ...
        public LetterEViewModel()
        {
            ...
            ContentList = new List<LetterAModel>
            {
                ...
                new LetterAModel { EnglishName = "Bird's cage", Image = "birdscage.JPG", Mp3Path = "BirdCage.mp3", TWIName = "Ebuo", TwiMp3Path = "EBUO.mp3"},
                new LetterAModel { EnglishName = "Darkness", Image = "darkness.jpg", Mp3Path = "DARKNESS.mp3", TWIName = "Esum", TwiMp3Path = "ESUM.mp3"},
                new LetterAModel { EnglishName = "Fire", Image = "fire.JPG", Mp3Path = "FIRE.mp3", TWIName = "Egya", TwiMp3Path = "EGYA.mp3"},
                ...
                new LetterAModel { EnglishName = "Sore", Image = "pain.jpg", Mp3Path = "SORE.mp3", TWIName = "Ekuro", TwiMp3Path = "EKURO.mp3"},
                new LetterAModel { EnglishName = "Scary", Image = "scary.jpg", Mp3Path = "SCARY.mp3", TWIName = "Ehu", TwiMp3Path = "EHU.mp3"},
